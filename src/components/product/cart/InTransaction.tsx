...
const ProductCartInTransaction: FC<ProductCartInTransactionProps> = ({
    product,
}) => {
    return (
        <div className="grid grid-cols-3 gap-3">
            <div className="col-span-1 h-[150px]">
                <img
                    src={`${UPLOAD_URL}/${product?.image?.toString()}`}
                    alt="Product"
            ...
            <div className="col-span-2 flex items-center justify-between flex-col gap-2">
                ...
                <div className="ml-4 flex items-center w-full text-[16px] mb-2">
                    {product?.size} |{" "}
                    <p className="capitalize ml-1 flex items-center gap-2">
                        {product?.color}
                        <p
