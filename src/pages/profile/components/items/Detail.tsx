...
const OrderDetail = () => {
    ...
    return (
        <div className='col-span-4 bg-white p-5 rounded-lg'>
            <Flex className='text-2xl font-medium text-gray-600 mb-5' gap={20}>
                <FaArrowLeftLong onClick={handleBackList} className="cursor-pointer" />
            ...
            <div className="info_group">
                <FlexBetween className="mb-3">
                    <p>Status</p>
                    <p className='px-4 py-1 rounded-lg bg-gray-100 font-medium capitalize'>{product?.status}</p>
                </FlexBetween>
                <FlexBetween className="mb-3">
                    <p>Purchase date</p>
                    <p className='px-4 py-1 font-medium'>{dayjs(product?.date).format(DATE_FORMAT)}</p>
                </FlexBetween>
                <FlexBetween className="mb-3">
                    <p>Invoice</p>
                    <p className='px-4 py-1 font-medium text-primary'>{product?.invoice}</p>
                </FlexBetween>
            </div>
            <Divider />
            ...
            <div className="info_group">
                ...
                <FlexBetween className="mb-3">
                    <p>No. Receipt</p>
                    <p className='px-4 py-1 font-medium text-primary'>{product?.receiptNumber}</p>
                </FlexBetween>
                <FlexBetween className="mb-3">
                    <p>Address</p>
            ...
            <div className="info_group">
                ...
                <FlexBetween className="mb-3">
                    <p>Total Shoping</p>
                    <p className='px-4 py-1 font-medium'>$ {product?.subTotal}</p>
                </FlexBetween>
                <FlexBetween className="mb-3">
                    <p>Shipping</p>
                    <p className='px-4 py-1 font-medium'>$ {product?.shipping}</p>
                </FlexBetween>
                <FlexBetween className="mb-3">
                    <p>Tax</p>
                    <p className='px-4 py-1 font-medium'>$ {product?.tax ? product?.tax : 0}</p>
                </FlexBetween>
                <FlexBetween className="mb-3">
                    <p className="text-primary">Discount</p>
                    <p className='px-4 py-1 font-medium text-primary'>-$ {product?.discount ? product?.discount : 0}</p>
                </FlexBetween>
            </div>
            <Divider />
            <FlexBetween className="mb-3">
                <p className="font-bold text-xl">Subtotal</p>
                <p className='text-xl px-4 py-1 font-bold'>$ {product?.subTotal}</p>
            </FlexBetween>
