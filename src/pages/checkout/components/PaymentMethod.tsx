    ...
    return (
        <div className='p-4 rounded-lg bg-white shadow-sm'>
            ...
            <Radio.Group className='w-full'>
                ...
                >
                    <Radio value={"cash"}>
                        <FlexCenter gap={10} className='mt-1 ml-1'>
                            ...
                            <p className='mb-0.5 font-medium'>Payment on delivery</p>
                        </FlexCenter>
                    </Radio>
                </FlexBetween>
                ...
                <Collapse defaultActiveKey={["bank"]} expandIconPosition={"end"}>
                    <Collapse.Panel
                        key="bank"
                        header={<FlexBetween>
                            <FlexCenter gap={10}>
                                <BsBank className={"text-2xl"} />
                                <p className='mb-0.5 font-medium'>VA & Bank Transfer</p>
                            </FlexCenter>
                        </FlexBetween>}
                    >
                        <Radio value={"visa"}>
                ...
                <Collapse defaultActiveKey={["eWallet"]} expandIconPosition={"end"}>
                    <Collapse.Panel
                        key="eWallet"
                        header={<Flex gap={10}>
